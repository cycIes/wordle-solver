...
def findPossibleWords(tree, possible_words, current_word, freq, locked, unlocked, bad_letters): # current_letters, known_letters, bad_letters, tree):
...
possible_words = []
updatePossibleWords(letter_tree, possible_words, "s_a_e", "___t_", ["r"])
